            ...
            <div class="card toolbar-demo">
                ...
                <Toolbar>
                    <template v-slot:start>
                        <Button label="New" icon="pi pi-plus" style="margin-right: 0.5em" />
                        <Button label="Open" icon="pi pi-folder-open" class="p-button-secondary" />

                        <i class="pi pi-bars p-toolbar-separator" style="margin-right: 0.5em"></i>

                        <Button icon="pi pi-check" class="p-button-success" style="margin-right: 0.5em" />
                        <Button icon="pi pi-trash" class="p-button-warning" style="margin-right: 0.5em" />
                ...
                <Splitter style="height: 300px" class="mb-5">
                    ...
                    <SplitterPanel :size="60" style="overflow: scroll">
                        <Splitter layout="vertical">
                            <SplitterPanel :size="25" style="overflow: scroll">
                                <p class="col">
                            ...
                            <SplitterPanel :size="75" style="overflow: scroll">
                                <p class="col">
                                    ...
                                    reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat. Donec vel volutpat ipsum. Integer nunc magna, posuere ut tincidunt eget, egestas vitae sapien. Morbi dapibus luctus
                                    odio.
                                </p>
                            </SplitterPanel>
                        </Splitter>
