    ...
    <div class="grid">
        <div class="col-12">
            <div class="card docs">
                ...
                <p>
                    Prestige is an application template for Vue 3 based on <a href="https://github.com/vuejs/create-vue" class="font-medium text-primary hover:underline">create-vue</a>, the recommended way to start a <strong>Vite-powered</strong> Vue
...
npm install
                ...
                <p>Next step is running the application using the serve script and navigate to <i>http://localhost:5173/</i> to view the application. That is it, you may now start with the development using the Prestige template.</p>
...
npm run dev
                ...
                <h4>Structure</h4>
                <p>Prestige consists of a couple folders, demos and layout have been separated so that you can easily remove what is not necessary for your application.</p>
...
export default router;
                ...
                <p>
                    Prestige provides 16 PrimeVue themes out of the box. Setup of a theme is simple by including the css of theme to your bundle that are located inside <span class="text-primary font-medium">public/theme/</span> folder such as
...
@import '../../../src/assets/sass/theme/_theme_dark';
                ...
                <pre class="app-code"><code>sass --update public/theme:public/theme</code></pre>
