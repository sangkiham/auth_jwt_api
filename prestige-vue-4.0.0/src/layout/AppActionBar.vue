    ...
    <div class="layout-actionbar">
        <div class="layout-breadcrumb">
            <span v-if="$route.meta.breadcrumb && $route.meta.breadcrumb[0]">
                ...
                <template v-for="item in $route.meta.breadcrumb" v-bind:key="item.id">
                    <span v-if="item.label"> <i class="pi pi-fw pi-chevron-right mr-1" style="font-size: 0.8rem"></i> </span>{{ item.label }}
                </template>
            </span>
        </div>
